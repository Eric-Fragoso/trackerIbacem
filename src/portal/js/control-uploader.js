function uploadGeral(controle, etapa){
  ...
  $('.btnAnexa').dmUploader(
    ...
    { //
    url: `http://138.204.68.18:3323/controles/gallery`,
    maxFileSize: 30000000, // 30 Megs max
    auto: false,
    queue: false,
    ...
    onUploadSuccess: function(id, data){
      ...
      ui_multi_update_file_status(id, 'successo', 'Envio realizado');
      ui_multi_update_file_progress(id, 100, 'successo', false);
    ...
    onUploadCanceled: function(id) {
      ...
      ui_multi_update_file_status(id, 'atenção', 'Cancelado pelo usuário');
      ui_multi_update_file_progress(id, 0, 'atenção', false);
